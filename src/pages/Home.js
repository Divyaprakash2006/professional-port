...
function Home() {
  ...
  return (
    <section className="home-hero image-bg" style={{ '--hero-bg': "url('pages/image.png')" }}>
      <div className="container home-content home-shift-up" style={{ position: 'relative', zIndex: 2 }}>
        {/* Professional Photo */}
        <div style={{ 
          display: 'flex', 
          ...
          <div style={{
            ...
            boxShadow: '0 0 40px rgba(108, 140, 255, 0.5), 0 0 80px rgba(34, 211, 238, 0.3)',
          ...
          onMouseEnter={(e) => {
            ...
            e.target.style.boxShadow = '0 0 40px rgba(108, 140, 255, 0.6), 0 0 80px rgba(34, 211, 238, 0.3)';
          }}
          onMouseLeave={(e) => {
            e.target.style.transform = 'scale(1)';
            e.target.style.boxShadow = '0 0 30px rgba(108, 140, 255, 0.4), 0 0 60px rgba(34, 211, 238, 0.2)';
          }}
          >
            <img 
              src={profilePhoto} 
        ...
        <h1 className="hero-title" style={{ textAlign: 'center', marginBottom: '15px', marginTop: '10px' }}>
          <Typewriter
        ...
        {showSummary && (
          <p className="lead" style={{ maxWidth: 780, textAlign: 'center', opacity: 0, animation: 'fadeIn 600ms forwards', marginTop: '10px', lineHeight: '1.6' }}>
            {resume.summary}
          </p>
        )}
      </div>
